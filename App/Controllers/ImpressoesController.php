...
class ImpressoesController extends Controller
{
    public function inserirRegistrosImpressoes(): void {
        ...
        if (isset($data['dados']) && !empty($data['dados'])) {
            foreach ($data['dados'] as $indice => $item) {
                $idFilial = $item['id_filial'];
                $idPromocao = $item['id_promocao'];
                $idProduto = $item['id_produto'];
                $idGradeX = $item['id_grade_x'];
                $idGradeY = $item['id_grade_y'];
                $idTipoPagamento = $item['id_tipo_pagamento'];
                $precoAPrazo = $item['preco_a_prazo'];
