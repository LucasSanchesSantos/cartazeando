<h3 class="text-center mb-4"><i class="bi bi-gear-fill me-2"></i> Tipo pagamento</h3>
...
<form action="<?= URL ?>tipoPagamento/editar" method="post">
    <input type="hidden" id="id" name="id" value=<?= !empty($_GET['id']) ? intval($_GET['id']) : intval($tipoPagamento['id']) ?>>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="id" name="id" value="<?= $this->viewVar['tipoPagamento']['id'] ?>" required disabled>
        </div>
        <div class="mb-3">
